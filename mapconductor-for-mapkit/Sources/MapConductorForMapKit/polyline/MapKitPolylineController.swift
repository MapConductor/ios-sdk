...
@MainActor
final class MapKitPolylineController: PolylineController<MKPolyline, MapKitPolylineOverlayRenderer> {
    ...
    init(mapView: MKMapView?) {
        ...
        let polylineManager = PolylineManager<MKPolyline>()
        let renderer = MapKitPolylineOverlayRenderer(mapView: mapView)
