...
head:
  - tag: meta
    attrs:
      name: description
      content: MapViewHolder — accede a la instancia nativa del mapa en MapConductor iOS SDK.
---
...
<CastMapViewExample commentForCast="Acceder a la vista nativa de Google Maps" />
