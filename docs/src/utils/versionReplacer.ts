import {
    ...
    HEATMAP_MODULE_VERSION,
    MARKER_CLUSTERING_MODULE_VERSION,
...
export const VERSION_IDENTIFIERS: Record<string, string> = {
    ...
    'HEATMAP_MODULE_VERSION': HEATMAP_MODULE_VERSION,
    'MARKER_CLUSTERING_MODULE_VERSION': MARKER_CLUSTERING_MODULE_VERSION,
