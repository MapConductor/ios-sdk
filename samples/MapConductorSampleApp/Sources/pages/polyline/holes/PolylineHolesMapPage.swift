...
struct PolylineHolesMapPage: View {
    let onToggleSidebar: () -> Void

    @State private var provider: MapProvider
    @StateObject private var viewModel: PolylineHolesMapPageViewModel
    ...
    init(onToggleSidebar: @escaping () -> Void = {}) {
        ...
        let vm = PolylineHolesMapPageViewModel()
