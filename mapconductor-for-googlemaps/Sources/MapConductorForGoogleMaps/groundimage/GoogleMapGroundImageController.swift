...
@MainActor
final class GoogleMapGroundImageController: GroundImageController<GMSGroundOverlay, GoogleMapGroundImageOverlayRenderer> {
    ...
    init(mapView: GMSMapView?) {
        ...
        let manager = GroundImageManager<GMSGroundOverlay>()
        let renderer = GoogleMapGroundImageOverlayRenderer(mapView: mapView)
