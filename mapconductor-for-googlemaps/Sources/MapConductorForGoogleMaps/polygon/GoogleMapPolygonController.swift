...
@MainActor
final class GoogleMapPolygonController: PolygonController<GMSPolygon, GoogleMapPolygonOverlayRenderer> {
    ...
    init(mapView: GMSMapView?) {
        ...
        let polygonManager = PolygonManager<GMSPolygon>()
        let renderer = GoogleMapPolygonOverlayRenderer(mapView: mapView)
